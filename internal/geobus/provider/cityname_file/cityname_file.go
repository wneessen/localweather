...
// NewCitynameFileProvider initializes a Provider with a file path and default update
...
func (p *Provider) readFile(ctx context.Context) (types.Coordinate, error) {
	...
	for line := range lines {
		...
		coords, err = p.coder.Search(ctx, line)
		if err != nil {
